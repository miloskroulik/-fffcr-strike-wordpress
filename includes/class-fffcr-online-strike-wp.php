...
class FFFCROnlineStrike_wp {
	...
	public function __construct() {
		if ( defined( 'FFFCR_ONLINE_STRIKE_VERSION' ) ) {
			$this->version = FFFCR_ONLINE_STRIKE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	 ...
	 *
	 * - FFFCR_ONLINE_STRIKE_Loader. Orchestrates the hooks of the plugin.
	 * - FFFCR_ONLINE_STRIKE_i18n. Defines internationalization functionality.
	 * - FFFCR_ONLINE_STRIKE_Admin. Defines all hooks for the admin area.
	 * - FFFCR_ONLINE_STRIKE_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the FFFCR_ONLINE_STRIKE_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
